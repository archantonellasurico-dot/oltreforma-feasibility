...
def make_pdf(p, r):
    ...
    y = H - 55
    txt(45, y, "OLTREFORMA | FEASIBILITY V3.2", 15, True); y -= 24
    ...
    c.drawString(45, 28, "Oltreforma | Feasibility V3.2 · Documento preliminare, non sostitutivo di perizia o verifica urbanistica/fiscale.")
...
# ---------- Studio tabs ----------
tabs = st.tabs(["Dashboard", "Immobile", "Urbanistica", "Product Mix", "Costi", "Mercato", "Alternative", "Incentivi", "Detrazioni 2026", "Acquisizione / Permuta", "Report", "Guida / Legenda"])
