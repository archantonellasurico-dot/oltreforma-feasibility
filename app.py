...
def make_pdf(p, r):
    ...
    y = H - 55
    txt(45, y, "OLTREFORMA | FEASIBILITY V3.6", 15, True); y -= 24
    ...
    c.drawString(45, 28, "Oltreforma | Feasibility V3.6 · Documento preliminare, non sostitutivo di perizia o verifica urbanistica/fiscale.")
